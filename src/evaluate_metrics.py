...
SCORES_CSV = PROCESSED_DIR / "lfw_scores.csv"
THRESHOLD_OUTPUT_CSV = OUTPUTS_DIR / "tables" / "threshold_metrics.csv"
GROUP_OUTPUT_CSV = OUTPUTS_DIR / "tables" / "group_metrics_by_threshold.csv"
